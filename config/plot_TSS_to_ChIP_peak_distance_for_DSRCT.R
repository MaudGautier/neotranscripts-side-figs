...
# Output
plot_name <- "./plots/DSRCT_distance.png"
name_neotranscripts <- "DSRCT"
lab_x <- "Distance between TSS and closest EwS-WT1 ChIP peak (log-scale)"
...
# Input data
neotranscripts_distance <- "./data/Closest_TSS_from_EwS_WT1_ChIP_peak_for_DSRCT_neotranscripts.txt"
hg19_distance <- "./data/Closest_TSS_from_EwS_WT1_ChIP_peak_for_all_hg19_transcripts.txt"
