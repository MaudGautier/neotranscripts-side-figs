...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
#                                                                              #
# TSS_to_ChIP_peak_distance_for_aRMS.sh                                        #
#                                                                              #
...
# Config plot to get the TSS to ChIP peak distances for aRMS neotranscripts.
...
ChIP_peaks_file=/data/kdi_prod/project_result/726/27.02/results/4_Macs/ChIP-PF_ChIP-PF_INPUT_0.05_peaks.narrowPeak
gtf_file=/data/kdi_prod/project_result/726/27.02/results/1_Data/200624_aRMS_neos_NEW_IDs.gtf
...
ChIP_summits=${output_dir}/PF_ChIP_peaks_summits.txt
...
# Get TSS to PF ChIP peak distance for all hg19 transcrips
output_file=${output_dir}/Closest_TSS_from_PF_ChIP_peak_for_all_hg19_transcripts.txt
sh ./src/sh/TSS_to_ChIP_peak_distance.sh \
	-i $hg19_gtf_file \
	-o $output_file \
	-t $temp_dir \
